...
TRANS_VEL_OPTS = [-0.05, 0, 0.05, 0.15]  # m/s, max of real robot is .26
ROT_VEL_OPTS = np.linspace(-1, 1, 9)  # rad/s, max of real robot is 1.82

# Control frequency
CONTROL_RATE = 5  # Hz, how frequently control signals are sent

# Time horizon simulation
CONTROL_HORIZON = 10  # seconds. if this is set too high and INTEGRATION_DT is too low, code will take a long time to run!
INTEGRATION_DT = 0.05  # s, delta t to propagate trajectories forward by
