...
def load_map_yaml(filename: str):
...
class Node:
    def __init__(self, pose: Pose, parent_id: int, cost: float):
        self.pose = pose # includes orientation theta
...
class PathPlanner:
    ...
    def check_if_duplicate(self, point: Point): # does this include (theta)?
        # Check if point is a duplicate of an already existing node
        print("TO DO: Check that nodes are not duplicates")
        return False

    def closest_node(self, point: Point):
        # Returns the index of the closest node
        print("TO DO: Implement a method to get the closest node to a sapled point")
        return 0

    def simulate_trajectory(self, node_i: Node, point_s: Point):
        # Simulates the non-holonomic motion of the robot.
        # This function drives the robot from node_i towards point_s. This function has many solutions!
    ...
    def robot_controller(self, node_i: Node, point_s: Point):
    ...
    def points_to_robot_circle(self, points: list[Point]):
    ...
    def connect_node_to_point(self, node_i: Node, point_f: Point):
